function GUID() {
  ...
  if (typeof this.createGUID != 'function') {
    ...
    * 返回值：返回转换后的字符串
    */
    this.hexadecimal = function (num, x, y) {
      if (y != undefined) {
    ...
    * 返回值：标准GUID格式的字符串
    */
    this.formatGUID = function (guidStr) {
